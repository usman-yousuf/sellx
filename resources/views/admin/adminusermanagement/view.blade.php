                                            ...
                                            <div class="card-body text-center">
                                                <div class="card-img-actions d-inline-block mb-3">
                                                    @if ($user_profile->profile_image)
                                                        <img class="rounded-circle" src="{{ asset('public/assets/images/').'/'.$user_profile->profile_image}}" width="170" height="170" alt="" />
                                                    @else
                                                        <img class="rounded-circle" src="{{ asset('public/assets/images/attachment.png')}}" width="170" height="170" alt="" />
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
