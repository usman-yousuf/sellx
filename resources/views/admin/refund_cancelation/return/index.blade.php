                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('admin.return.edit') }}" class="dropdown-item"><i class="icon-pencil3"></i> Eidt</a>
                                                <a href="javascript:void(0)" class="dropdown-item"><i class="icon-trash-alt"></i> Delete</a>
                                                <a href="{{ route('admin.return.detail') }}" class="dropdown-item"><i class="icon-eye2"></i> Detail View</a>
