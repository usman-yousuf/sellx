    ...
    <!-- Page header -->
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Update Currency</span>
                        </div>
            ...
            <div class="content">
                ...
                <div class="card-body">
                    ...
                    <form id="create_category" action="{{ route('admin.currencies.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Symbol" id="txt_symbol-d" name="symbol" value="{{$data->symbol ?? 'not set'}}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
